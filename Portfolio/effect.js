...
const saluteTextContainer = document.querySelector(".text-1")
const saluteImgContainer = document.querySelector(".model")
const authorName = document.querySelector(".text-2")
const jobTitleContainers = document.querySelector(".text-3")
...
window.addEventListener("scroll", ()=>{
  ...
  saluteImgContainer.style.transform= `translate(${-offsetY * 0.6}px)`
  authorName.style.transform= `translateX(${offsetY * 0.1}px)`
  jobTitleContainers.style.transform= `translateX(${-offsetY * 0.1}px)`
})